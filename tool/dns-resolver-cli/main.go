...
import (
	...
	"github.com/mtenrero/dockerDnsrr-discovery/client"
	"github.com/mtenrero/dockerDnsrr-discovery/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "DNS Resolver-cli",
		Short: `CLI client for the DNS Resolver service`,
	}
	...
	c.UserAgent = "DNS Resolver-cli/0"
